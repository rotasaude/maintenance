// Design tokens do app de Manutenção.
// Copiado de apps/dashboard/src/theme/tokens.ts (mesma estética: console
// técnico sóbrio, neutros frios em oklch), com o token extra `envBanner`
// (spec F6) para a faixa de ambiente que nunca sai do topo da tela.
...
export const tokens = {
  ...
  // Faixa de ambiente (spec F6): com alcance total sobre as cidades,
  // confundir staging com dev é o erro mais caro que a tela pode induzir.
  envBanner: {
